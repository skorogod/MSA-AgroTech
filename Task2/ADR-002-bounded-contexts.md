...
- Восемь сервисов на ферме: выше требования к серверу и сложнее обновление.
...
- Данные хранятся в двух местах с расхождением до 10 минут. Источник данных по событиям — агент фермы.
